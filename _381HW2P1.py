...
def main():
    ...
    rArr = error(sArr) #creates a recieved array with the potential for errors
    #loops through the sent and recieved arrays to count the number of identical messages
